    ...
    dbc.Container([
        ...
        dbc.Row([
            dbc.Col([
                ...
                html.Br(),
                dbc.Card(id="card_1_p2", body=True),
                dbc.Button("Click",
                           id="btn_1_p2",
                           outline=True,
                           color="primary",
                ...
                html.Br(),
                dbc.Card(id="card_2_p2", body=True),
                dbc.Button("Click",
                           id="btn_2_p2",
                           outline=True,
                           color="primary",
                ...
                html.Br(),
                dbc.Card(id="card_3_p2", body=True),
                dbc.Button("Click",
                           id="btn_3_p2",
                           outline=True,
                           color="primary",
                ...
                html.Br(),
                dbc.Card(id="card_4_p2", body=True),
                dbc.Button("Click",
                           id="btn_4_p2",
                           outline=True,
                           color="primary",
                ...
                html.Br(),
                dbc.Card(id="card_5_p2", body=True),
                dbc.Button("Click",
                           id="btn_5_p2",
                           outline=True,
                           color="primary",
                ...
                html.Br(),
                dbc.Card(id="card_6_p2", body=True),
                dbc.Button("Click",
                           id="btn_6_p2",
                           outline=True,
                           color="primary",
